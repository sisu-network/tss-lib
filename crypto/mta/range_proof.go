...
func ProveRangeAlice(curve string, pk *paillier.PublicKey, c, NTilde, h1, h2, m, r *big.Int) (*RangeProofAlice, error) {
...
func (pf *RangeProofAlice) Verify(curve string, pk *paillier.PublicKey, NTilde, h1, h2, c *big.Int) bool {
