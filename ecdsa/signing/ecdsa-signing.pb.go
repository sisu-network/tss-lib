...
func (x *SignRound1Message) GetSi() []byte {
	if x != nil {
		return x.Si
	}
	return nil
...
var file_ecdsa_signing_proto_rawDesc = []byte{
	0x0a, 0x13, 0x65, 0x63, 0x64, 0x73, 0x61, 0x2d, 0x73, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x23, 0x0a, 0x11, 0x53, 0x69, 0x67, 0x6e, 0x52, 0x6f, 0x75,
	0x6e, 0x64, 0x31, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x73, 0x69,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x02, 0x73, 0x69, 0x42, 0x0f, 0x5a, 0x0d, 0x65, 0x63,
...
var (
	...
	file_ecdsa_signing_proto_rawDescData = file_ecdsa_signing_proto_rawDesc
)

func file_ecdsa_signing_proto_rawDescGZIP() []byte {
	file_ecdsa_signing_proto_rawDescOnce.Do(func() {
		file_ecdsa_signing_proto_rawDescData = protoimpl.X.CompressGZIP(file_ecdsa_signing_proto_rawDescData)
	})
	return file_ecdsa_signing_proto_rawDescData
}

var file_ecdsa_signing_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ecdsa_signing_proto_goTypes = []interface{}{
...
func file_ecdsa_signing_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_ecdsa_signing_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ecdsa_signing_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_ecdsa_signing_proto_rawDesc = nil
